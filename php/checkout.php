    ...
    <body>
        ...
        <main class="checkout-wrapper">
            ...
            <div class="checkout-form">
                <form action="proses_checkout.php" method="POST" onsubmit="return konfirmasiCheckout();">
                    ...
                    <p class="total">Total: Rp<span id="total"><?= number_format($product['price'], 0, ',', '.') ?></span></p>
